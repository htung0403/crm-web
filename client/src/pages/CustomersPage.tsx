                ...
                <div className="space-y-4 py-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="col-span-2 space-y-2">
                            <Label>{type === 'company' ? 'Tên công ty *' : 'Họ và tên *'}</Label>
                            <Input value={name} onChange={(e) => setName(e.target.value)} placeholder={type === 'company' ? 'Nhập tên công ty' : 'Nhập họ và tên'} />
                        </div>
                        <div className="space-y-2">
                            <Label>Email</Label>
                    ...
                    {type === 'company' && (
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input value={company} onChange={(e) => setCompany(e.target.value)} placeholder="Tên người liên hệ" />
                            </div>
                            <div className="space-y-2">
