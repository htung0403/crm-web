...
export const orderItemsApi = {
    ...
    updateStatus: (id: string, status: string, reason?: string, warranty_code?: string, photos?: string[]) =>
        api.patch<ApiResponse<any>>(`/order-items/${id}/status`, { status, reason, warranty_code, photos }),
